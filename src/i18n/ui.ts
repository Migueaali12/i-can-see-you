...
export const ui = {
  en: {
    ...
    'results.chartFocus': 'Focused',
    'results.chartDistracted': 'Distracted',
    'results.chartAttention': 'Attention',
    'results.chartNoIncidents': 'Perfect focus — no incidents this session',
  ...
  es: {
    ...
    'results.timelineStart': '0:00',
    'results.chartFocus': 'Concentrado',
    'results.chartDistracted': 'Distraído',
    'results.chartAttention': 'Atención',
    'results.chartNoIncidents': 'Enfoque perfecto — sin incidentes en esta sesión',
    ...
    'results.cardScoreLabel': 'Score de Atención',
