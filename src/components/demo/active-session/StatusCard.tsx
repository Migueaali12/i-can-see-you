...
import { t, SIGNAL_LABELS, shadow6, cardWrapperStatus } from "./styles"
...
export default function StatusCard({
  ...
  const Icon = status === "out_of_focus" || status === "event_detected" ? EyeOff : ScanEye
  const iconColor = cfg.dark ? "#fff" : "#111"

  return (
    <div style={cardWrapperStatus}>
